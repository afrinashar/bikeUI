        ...
        <div className=" flex flex-row  flex justify-end gap-3 ">
          ...
          <div className=" flex w-5/6  flex-6 flex-row p-4 rounded-xl bg-indigo-200 divide-x divide-black > * + * border border-blue-900 border-solid border-2 gap-2 place-content-center">
            ...
            <div className="divide-y m-2 divide-slate-500 > * + * p-5  gap-3 flex flex w-3/6 flex-col">
              <h2 className="text-xl font-bold m-1 ">Specification</h2>
              <div className="flex flex-row">
                {" "}
                <h3 className="text-sm m-1 flex-1"> Engine & Transmission</h3>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-4 h-4 m-1 flex-none"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="flex flex-row">
                {" "}
                <h3 className="text-sm m-1 flex-1">Features</h3>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <div className="flex flex-row">
                {" "}
                <h3 className="text-sm m-1 flex-1">Mileage & Performance</h3>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <div className="flex flex-row">
                {" "}
                <h3 className="text-sm m-1 flex-1">Chassis & Suspension</h3>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
